...
type IRefreshTokenCreationAttributes = Optional<
    ...
    'id' | 'revoked' | 'created_at' | 'replaced_by' | 'last_used_at'
>;
    ...
    RefreshToken.init(
        {
            ...
            // FIXED ↓↓↓
            ip: {
                type: DataTypes.STRING(255), // increased from 50 → 255
                allowNull: true,
            },

            // FIXED ↓↓↓
            user_agent: {
                type: DataTypes.TEXT, // changed from VARCHAR(255) → TEXT
                allowNull: true,
            },
        ...
        },
        {
            ...
            indexes: [
                ...
                { fields: ['token_hash'], name: 'idx_refresh_tokens_token_hash' },
